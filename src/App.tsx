    ...
    <section id="work" className="py-32 bg-secondary/20">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 auto-rows-fr">
          {filtered.map((p, i) => (
            <div key={i} className="group relative overflow-hidden rounded-2xl hoverable border border-white/5 h-80" onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave}>
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (rect.top < startPoint && rect.bottom > endPoint) {
        ...
        setFill(Math.min(100, Math.max(0, (scrolled / total) * 100)));
      }
    };
    window.addEventListener('scroll', handleScroll);
    handleScroll();
...
const ContactCTA = () => (
  <section className="py-32 relative overflow-hidden">
    ...
    <div className="container mx-auto px-6 relative z-10 text-center">
      ...
      <h2 className="font-display text-5xl md:text-7xl tracking-tight relative">LET'S BUILD YOUR<br/><span className="gradient-text">NEXT BIG IDEA.</span></h2>
      <p className="text-lg text-gray-400 mt-6 max-w-2xl mx-auto text-balance">Tell us what you want to build. We'll help turn the idea into a professional digital solution.</p>
      <MagneticButton href="#contact" className="bg-accent text-black px-8 py-4 rounded-full font-semibold mt-8 hover:bg-white group">
